...
<div class="step__header">
    ...
    <h2 class="step__title">Enfermedades con mayor frecuencia</h2>
</div>    
    ...
    series: [{
        ...
        <?php  
            for($i=0; $i<sizeof($enf); $i++){
                ...
                $his = $enfermedad->get_historial_por_id_enfermedad($enf[$i]["id_enfermedad"]);

                $datos_encontrados = array();

                $datos_encontrados["id"] = $enf[$i]["id_enfermedad"];
                $nombre = $datos_encontrados["nombre"] = $enf[$i]["nombre"];
