...
function init(){
	...
	$("#especialidad_form").on("submit",function(e)
	{
...
function listar()
{
	tabla=$('#especialidad_data').dataTable(
	{
...
function mostrar(id_especialidad)
{
	$.post("../ajax/especialidad.php?op=mostrar",{id_especialidad : id_especialidad}, function(data, status)
	{
...
function guardaryeditar(e)
{
	...
	var formData = new FormData($("#especialidad_form")[0]);
		...
		$.ajax({
		    ...
		    {                    
	            ...
	            $('#especialidad_form')[0].reset();
				$('#especialidadModal').modal('hide');

				$('#resultados_ajax').html(datos);
				$('#especialidad_data').DataTable().ajax.reload();
